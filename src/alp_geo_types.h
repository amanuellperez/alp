 ...
 *	el código.
 *
 *  TODO: que Posicion_ij y Punto_xy suministren el mismo interfaz
 *	(a fin de cuentas es el mismo concepto (???)) 
 *
 *   - HISTORIA:
 *           alp  - 14/10/2017 Reescrito
...
#include "alp_math.h"	// cociente. TODO: eliminar esta dependencia
			// solo lo uso en vis_rayo_color creo

#include "alp_indices.h" // TODO: creo que esta se podrá quitar en el futuro
...
template <typename Int>
struct Coordenada_traits<Posicion_ij<Int>>{
 ...
 *  Rectangulo<Posicion_ij>. El problema es que hablamos de forma distinta
